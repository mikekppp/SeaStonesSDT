...
#include "ApplePihpsdr_Defines.h"
...
static const ENCODER encoders_no_controller[MAX_ENCODERS] = {
  {G_FALSE, G_TRUE, 0, 0, 0, 0, 0, 0, R_START, G_FALSE, G_TRUE, 0, 0, 0, 0, 0, 0, R_START, G_FALSE, G_TRUE, 0, 0, 0L},
  {G_FALSE, G_TRUE, 0, 0, 0, 0, 0, 0, R_START, G_FALSE, G_TRUE, 0, 0, 0, 0, 0, 0, R_START, G_FALSE, G_TRUE, 0, 0, 0L},
  {G_FALSE, G_TRUE, 0, 0, 0, 0, 0, 0, R_START, G_FALSE, G_TRUE, 0, 0, 0, 0, 0, 0, R_START, G_FALSE, G_TRUE, 0, 0, 0L},
  {G_FALSE, G_TRUE, 0, 0, 0, 0, 0, 0, R_START, G_FALSE, G_TRUE, 0, 0, 0, 0, 0, 0, R_START, G_FALSE, G_TRUE, 0, 0, 0L},
  {G_FALSE, G_TRUE, 0, 0, 0, 0, 0, 0, R_START, G_FALSE, G_TRUE, 0, 0, 0, 0, 0, 0, R_START, G_FALSE, G_TRUE, 0, 0, 0L},
...
static const ENCODER encoders_controller1[MAX_ENCODERS] = {
  {G_TRUE,  G_TRUE, 20, 1, 26, 1, 0, AF_GAIN,  R_START, G_FALSE, G_TRUE, 0, 0, 0, 0, 0, 0, R_START, G_TRUE,  G_TRUE, 25, MENU_BAND,       0L},
  {G_TRUE,  G_TRUE, 16, 1, 19, 1, 0, AGC_GAIN, R_START, G_FALSE, G_TRUE, 0, 0, 0, 0, 0, 0, R_START, G_TRUE,  G_TRUE,  8, MENU_BANDSTACK,  0L},
  {G_TRUE,  G_TRUE,  4, 1, 21, 1, 0, DRIVE,    R_START, G_FALSE, G_TRUE, 0, 0, 0, 0, 0, 0, R_START, G_TRUE,  G_TRUE,  7, MENU_MODE,       0L},
  {G_TRUE,  G_TRUE, 18, 1, 17, 1, 0, VFO,      R_START, G_FALSE, G_TRUE, 0, 0, 0, 0, 0, 0, R_START, G_FALSE, G_TRUE,  0, NO_ACTION,       0L},
  {G_FALSE, G_TRUE, 0, 1,  0, 0, 1, NO_ACTION, R_START, G_FALSE, G_TRUE, 0, 0, 0, 0, 0, 0, R_START, G_FALSE, G_TRUE,  0, NO_ACTION,       0L},
};

static const ENCODER encoders_controller2_v1[MAX_ENCODERS] = {
  {G_TRUE, G_TRUE, 20, 1, 26, 1, 0, AF_GAIN,  R_START, G_FALSE, G_TRUE, 0, 0, 0, 0, 0, 0, R_START, G_TRUE,  G_TRUE, 22, MENU_BAND,      0L},
  {G_TRUE, G_TRUE,  4, 1, 21, 1, 0, AGC_GAIN, R_START, G_FALSE, G_TRUE, 0, 0, 0, 0, 0, 0, R_START, G_TRUE,  G_TRUE, 27, MENU_BANDSTACK, 0L},
  {G_TRUE, G_TRUE, 16, 1, 19, 1, 0, IF_WIDTH, R_START, G_FALSE, G_TRUE, 0, 0, 0, 0, 0, 0, R_START, G_TRUE,  G_TRUE, 23, MENU_MODE,      0L},
  {G_TRUE, G_TRUE, 25, 1,  8, 1, 0, RIT,      R_START, G_FALSE, G_TRUE, 0, 0, 0, 0, 0, 0, R_START, G_TRUE,  G_TRUE, 24, MENU_FREQUENCY, 0L},
  {G_TRUE, G_TRUE, 18, 1, 17, 1, 0, VFO,      R_START, G_FALSE, G_TRUE, 0, 0, 0, 0, 0, 0, R_START, G_FALSE, G_TRUE,  0, NO_ACTION,      0L},
};

static const ENCODER encoders_controller2_v2[MAX_ENCODERS] = {
  {G_TRUE, G_TRUE,  5, 1,  6, 1, 0, AGC_GAIN_RX1, R_START1, G_TRUE,  G_TRUE, 26, 1, 20, 1, 0, AF_GAIN_RX1, R_START1, G_TRUE,  G_TRUE, 22, RX1,            0L}, //ENC2
  {G_TRUE, G_TRUE,  9, 1,  7, 1, 0, AGC_GAIN_RX2, R_START1, G_TRUE,  G_TRUE, 21, 1,  4, 1, 0, AF_GAIN_RX2, R_START1, G_TRUE,  G_TRUE, 27, RX2,            0L}, //ENC3
  {G_TRUE, G_TRUE, 11, 1, 10, 1, 0, DIV_GAIN,     R_START1, G_TRUE,  G_TRUE, 19, 1, 16, 1, 0, DIV_PHASE,   R_START1, G_TRUE,  G_TRUE, 23, DIV,            0L}, //ENC4
  {G_TRUE, G_TRUE, 13, 1, 12, 1, 0, XIT,          R_START1, G_TRUE,  G_TRUE,  8, 1, 25, 1, 0, RIT,         R_START1, G_TRUE,  G_TRUE, 24, MENU_FREQUENCY, 0L}, //ENC5
  {G_TRUE, G_TRUE, 18, 1, 17, 1, 0, VFO,          R_START,  G_FALSE, G_TRUE,  0, 0,  0, 0, 0, NO_ACTION,   R_START, G_FALSE,  G_TRUE,  0, NO_ACTION,      0L}, //ENC1/VFO
};

static const ENCODER encoders_g2_frontpanel[MAX_ENCODERS] = {
  {G_TRUE, G_TRUE,  5, 1,  6, 1, 0, DRIVE,    R_START1, G_TRUE,  G_TRUE, 26, 1, 20, 1, 0, MIC_GAIN,  R_START1, G_TRUE,  G_TRUE, 22, PS,             0L}, //ENC1
  {G_TRUE, G_TRUE,  9, 1,  7, 1, 0, AGC_GAIN, R_START1, G_TRUE,  G_TRUE, 21, 1,  4, 1, 0, AF_GAIN,   R_START1, G_TRUE,  G_TRUE, 27, MUTE,           0L}, //ENC3
  {G_TRUE, G_TRUE, 11, 1, 10, 1, 0, DIV_GAIN, R_START1, G_TRUE,  G_TRUE, 19, 1, 16, 1, 0, DIV_PHASE, R_START1, G_TRUE,  G_TRUE, 23, DIV,            0L}, //ENC7
  {G_TRUE, G_TRUE, 13, 1, 12, 1, 0, XIT,      R_START1, G_TRUE,  G_TRUE,  8, 1, 25, 1, 0, RIT,       R_START1, G_TRUE,  G_TRUE, 24, MENU_FREQUENCY, 0L}, //ENC5
  {G_TRUE, G_TRUE, 18, 1, 17, 1, 0, VFO,      R_START,  G_FALSE, G_TRUE,  0, 0,  0, 0, 0, 0,         R_START, G_FALSE,  G_TRUE,  0, NO_ACTION,      0L}, //VFO
};

static const SWITCH switches_no_controller[MAX_SWITCHES] = {
  {G_FALSE, G_FALSE, 0, NO_ACTION, 0L},
  {G_FALSE, G_FALSE, 0, NO_ACTION, 0L},
  {G_FALSE, G_FALSE, 0, NO_ACTION, 0L},
  {G_FALSE, G_FALSE, 0, NO_ACTION, 0L},
  {G_FALSE, G_FALSE, 0, NO_ACTION, 0L},
...
SWITCH switches_controller1[MAX_FUNCTIONS][MAX_SWITCHES] = {
  { {G_TRUE,  G_TRUE, 27, MOX,            0L},
    {G_TRUE,  G_TRUE, 13, MENU_BAND,      0L},
    {G_TRUE,  G_TRUE, 12, MENU_BANDSTACK, 0L},
    {G_TRUE,  G_TRUE,  6, MENU_MODE,      0L},
    {G_TRUE,  G_TRUE,  5, MENU_FILTER,    0L},
    {G_TRUE,  G_TRUE, 24, MENU_NOISE,     0L},
    {G_TRUE,  G_TRUE, 23, MENU_AGC,       0L},
    {G_TRUE,  G_TRUE, 22, FUNCTION,       0L},
    {G_FALSE, G_FALSE, 0, NO_ACTION,      0L},
    {G_FALSE, G_FALSE, 0, NO_ACTION,      0L},
    {G_FALSE, G_FALSE, 0, NO_ACTION,      0L},
    {G_FALSE, G_FALSE, 0, NO_ACTION,      0L},
  ...
  { {G_TRUE,  G_TRUE, 27, MOX,            0L},
    {G_TRUE,  G_TRUE, 13, LOCK,           0L},
    {G_TRUE,  G_TRUE, 12, CTUN,           0L},
    {G_TRUE,  G_TRUE,  6, A_TO_B,         0L},
    {G_TRUE,  G_TRUE,  5, B_TO_A,         0L},
    {G_TRUE,  G_TRUE, 24, A_SWAP_B,       0L},
    {G_TRUE,  G_TRUE, 23, SPLIT,          0L},
    {G_TRUE,  G_TRUE, 22, FUNCTION,       0L},
    {G_FALSE, G_FALSE, 0, NO_ACTION,      0L},
    {G_FALSE, G_FALSE, 0, NO_ACTION,      0L},
    {G_FALSE, G_FALSE, 0, NO_ACTION,      0L},
  ...
  { {G_TRUE,  G_TRUE, 27, MOX,            0L},
    {G_TRUE,  G_TRUE, 13, MENU_FREQUENCY, 0L},
    {G_TRUE,  G_TRUE, 12, MENU_MEMORY,    0L},
    {G_TRUE,  G_TRUE,  6, RIT_ENABLE,     0L},
    {G_TRUE,  G_TRUE,  5, RIT_PLUS,       0L},
    {G_TRUE,  G_TRUE, 24, RIT_MINUS,      0L},
    {G_TRUE,  G_TRUE, 23, RIT_CLEAR,      0L},
    {G_TRUE,  G_TRUE, 22, FUNCTION,       0L},
    {G_FALSE, G_FALSE, 0, NO_ACTION,      0L},
    {G_FALSE, G_FALSE, 0, NO_ACTION,      0L},
    {G_FALSE, G_FALSE, 0, NO_ACTION,      0L},
  ...
  { {G_TRUE,  G_TRUE, 27, MOX,            0L},
    {G_TRUE,  G_TRUE, 13, MENU_FREQUENCY, 0L},
    {G_TRUE,  G_TRUE, 12, MENU_MEMORY,    0L},
    {G_TRUE,  G_TRUE,  6, XIT_ENABLE,     0L},
    {G_TRUE,  G_TRUE,  5, XIT_PLUS,       0L},
    {G_TRUE,  G_TRUE, 24, XIT_MINUS,      0L},
    {G_TRUE,  G_TRUE, 23, XIT_CLEAR,      0L},
    {G_TRUE,  G_TRUE, 22, FUNCTION,       0L},
    {G_FALSE, G_FALSE, 0, NO_ACTION,      0L},
    {G_FALSE, G_FALSE, 0, NO_ACTION,      0L},
    {G_FALSE, G_FALSE, 0, NO_ACTION,      0L},
  ...
  { {G_TRUE,  G_TRUE, 27, MOX,            0L},
    {G_TRUE,  G_TRUE, 13, MENU_FREQUENCY, 0L},
    {G_TRUE,  G_TRUE, 12, SPLIT,          0L},
    {G_TRUE,  G_TRUE,  6, DUPLEX,         0L},
    {G_TRUE,  G_TRUE,  5, SAT,            0L},
    {G_TRUE,  G_TRUE, 24, RSAT,           0L},
    {G_TRUE,  G_TRUE, 23, MENU_BAND,      0L},
    {G_TRUE,  G_TRUE, 22, FUNCTION,       0L},
    {G_FALSE, G_FALSE, 0, NO_ACTION,      0L},
    {G_FALSE, G_FALSE, 0, NO_ACTION,      0L},
    {G_FALSE, G_FALSE, 0, NO_ACTION,      0L},
  ...
  { {G_TRUE,  G_TRUE, 27, MOX,            0L},
    {G_TRUE,  G_TRUE, 13, TUNE,           0L},
    {G_TRUE,  G_TRUE, 12, TUNE_FULL,      0L},
    {G_TRUE,  G_TRUE,  6, TUNE_MEMORY,    0L},
    {G_TRUE,  G_TRUE,  5, MENU_BAND,      0L},
    {G_TRUE,  G_TRUE, 24, MENU_MODE,      0L},
    {G_TRUE,  G_TRUE, 23, MENU_FILTER,    0L},
    {G_TRUE,  G_TRUE, 22, FUNCTION,       0L},
    {G_FALSE, G_FALSE, 0, NO_ACTION,      0L},
    {G_FALSE, G_FALSE, 0, NO_ACTION,      0L},
    {G_FALSE, G_FALSE, 0, NO_ACTION,      0L},
...
static const SWITCH switches_controller2_v1[MAX_SWITCHES] = {
  {G_FALSE, G_FALSE, 0, MOX,              0L},
  {G_FALSE, G_FALSE, 0, TUNE,             0L},
  {G_FALSE, G_FALSE, 0, PS,               0L},
  {G_FALSE, G_FALSE, 0, TWO_TONE,         0L},
  {G_FALSE, G_FALSE, 0, NR,               0L},
  {G_FALSE, G_FALSE, 0, A_TO_B,           0L},
  {G_FALSE, G_FALSE, 0, B_TO_A,           0L},
  {G_FALSE, G_FALSE, 0, MODE_MINUS,       0L},
  {G_FALSE, G_FALSE, 0, BAND_MINUS,       0L},
  {G_FALSE, G_FALSE, 0, MODE_PLUS,        0L},
  {G_FALSE, G_FALSE, 0, BAND_PLUS,        0L},
  {G_FALSE, G_FALSE, 0, XIT_ENABLE,       0L},
  {G_FALSE, G_FALSE, 0, NB,               0L},
  {G_FALSE, G_FALSE, 0, SNB,              0L},
  {G_FALSE, G_FALSE, 0, LOCK,             0L},
  {G_FALSE, G_FALSE, 0, CTUN,             0L}
};

static const SWITCH switches_controller2_v2[MAX_SWITCHES] = {
  {G_FALSE, G_FALSE, 0, MOX,              0L},  //GPB7 SW2
  {G_FALSE, G_FALSE, 0, TUNE,             0L},  //GPB6 SW3
  {G_FALSE, G_FALSE, 0, PS,               0L},  //GPB5 SW4
  {G_FALSE, G_FALSE, 0, TWO_TONE,         0L},  //GPB4 SW5
  {G_FALSE, G_FALSE, 0, NR,               0L},  //GPA3 SW6
  {G_FALSE, G_FALSE, 0, NB,               0L},  //GPB3 SW14
  {G_FALSE, G_FALSE, 0, SNB,              0L},  //GPB2 SW15
  {G_FALSE, G_FALSE, 0, XIT_ENABLE,       0L},  //GPA7 SW13
  {G_FALSE, G_FALSE, 0, BAND_PLUS,        0L},  //GPA6 SW12
  {G_FALSE, G_FALSE, 0, MODE_PLUS,        0L},  //GPA5 SW11
  {G_FALSE, G_FALSE, 0, BAND_MINUS,       0L},  //GPA4 SW10
  {G_FALSE, G_FALSE, 0, MODE_MINUS,       0L},  //GPA0 SW9
  {G_FALSE, G_FALSE, 0, A_TO_B,           0L},  //GPA2 SW7
  {G_FALSE, G_FALSE, 0, B_TO_A,           0L},  //GPA1 SW8
  {G_FALSE, G_FALSE, 0, LOCK,             0L},  //GPB1 SW16
  {G_FALSE, G_FALSE, 0, CTUN,             0L}   //GPB0 SW17
};

static const SWITCH switches_g2_frontpanel[MAX_SWITCHES] = {
  {G_FALSE, G_FALSE, 0, XIT_ENABLE,       0L},  //GPB7 SW22
  {G_FALSE, G_FALSE, 0, RIT_ENABLE,       0L},  //GPB6 SW21
  {G_FALSE, G_FALSE, 0, FUNCTION,         0L},  //GPB5 SW20
  {G_FALSE, G_FALSE, 0, SPLIT,            0L},  //GPB4 SW19
  {G_FALSE, G_FALSE, 0, LOCK,             0L},  //GPA3 SW9
  {G_FALSE, G_FALSE, 0, B_TO_A,           0L},  //GPB3 SW18
  {G_FALSE, G_FALSE, 0, A_TO_B,           0L},  //GPB2 SW17
  {G_FALSE, G_FALSE, 0, MODE_MINUS,       0L},  //GPA7 SW13
  {G_FALSE, G_FALSE, 0, BAND_PLUS,        0L},  //GPA6 SW12
  {G_FALSE, G_FALSE, 0, FILTER_PLUS,      0L},  //GPA5 SW11
  {G_FALSE, G_FALSE, 0, MODE_PLUS,        0L},  //GPA4 SW10
  {G_FALSE, G_FALSE, 0, MOX,              0L},  //GPA0 SW6
  {G_FALSE, G_FALSE, 0, CTUN,             0L},  //GPA2 SW8
  {G_FALSE, G_FALSE, 0, TUNE,             0L},  //GPA1 SW7
  {G_FALSE, G_FALSE, 0, BAND_MINUS,       0L},  //GPB1 SW16
  {G_FALSE, G_FALSE, 0, FILTER_MINUS,     0L}   //GPB0 SW15
};
...
int gpio_init(void) {
  ...
  if (controller == CONTROLLER2_V1 || controller == CONTROLLER2_V2 || controller == G2_FRONTPANEL) {
    ...
    if ((ret = setup_input_line(chip, I2C_INTERRUPT, G_TRUE)) < 0) {
      goto err;
    }
  }
  ...
  if (CWL_LINE >= 0) {
    if (setup_input_line(chip, CWL_LINE, G_TRUE) < 0) {
  ...
  if (CWR_LINE >= 0) {
    if (setup_input_line(chip, CWR_LINE, G_TRUE) < 0) {
  ...
  if (CWKEY_LINE >= 0) {
    if (setup_input_line(chip, CWKEY_LINE, G_TRUE) < 0) {
  ...
  if (PTTIN_LINE >= 0) {
    if (setup_input_line(chip, PTTIN_LINE, G_TRUE) < 0) {
      t_print("%s: CWKEY line setup failed\n", __FUNCTION__);
    } else {
      have_button = 1;
    }
