...
static void activate_pihpsdr(GtkApplication *app, gpointer data) {
  ...
  gtk_window_set_resizable(GTK_WINDOW(top_window), G_FALSE);
  //
  ...
  gtk_grid_set_row_homogeneous(GTK_GRID(topgrid), G_FALSE);
  gtk_grid_set_column_homogeneous(GTK_GRID(topgrid), G_FALSE);
