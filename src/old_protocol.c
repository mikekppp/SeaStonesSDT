...
static void ozy_send_buffer(void) {
  ...
  if (metis_offset == 8) {
    ...
    //
    if (radio_is_transmitting() && transmitter->puresignal) { i = adc[2].adcAntenna; }
    ...
    case 3: { // TX drive level, filters, etc.
      ...
      //
      if (radio_is_transmitting() && transmitter->puresignal && adc[2].adcAntenna == 6) {
