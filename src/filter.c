...
void filterRestoreState(void) {
	GetPropLL0("filter.lsb.var1.low",            filterLSB[filterVar1].low);
	GetPropLL0("filter.lsb.var1.high",           filterLSB[filterVar1].high);
	GetPropLL0("filter.lsb.var2.low",            filterLSB[filterVar2].low);
	GetPropLL0("filter.lsb.var2.high",           filterLSB[filterVar2].high);
	GetPropLL0("filter.digl.var1.low",           filterDIGL[filterVar1].low);
	GetPropLL0("filter.digl.var1.high",          filterDIGL[filterVar1].high);
	GetPropLL0("filter.digl.var2.low",           filterDIGL[filterVar2].low);
	GetPropLL0("filter.digl.var2.high",          filterDIGL[filterVar2].high);
	GetPropLL0("filter.cwl.var1.low",            filterCWL[filterVar1].low);
	GetPropLL0("filter.cwl.var1.high",           filterCWL[filterVar1].high);
	GetPropLL0("filter.cwl.var2.low",            filterCWL[filterVar2].low);
	GetPropLL0("filter.cwl.var2.high",           filterCWL[filterVar2].high);
	GetPropLL0("filter.usb.var1.low",            filterUSB[filterVar1].low);
	GetPropLL0("filter.usb.var1.high",           filterUSB[filterVar1].high);
	GetPropLL0("filter.usb.var2.low",            filterUSB[filterVar2].low);
	GetPropLL0("filter.usb.var2.high",           filterUSB[filterVar2].high);
	GetPropLL0("filter.digu.var1.low",           filterDIGU[filterVar1].low);
	GetPropLL0("filter.digu.var1.high",          filterDIGU[filterVar1].high);
	GetPropLL0("filter.digu.var2.low",           filterDIGU[filterVar2].low);
	GetPropLL0("filter.digu.var2.high",          filterDIGU[filterVar2].high);
	GetPropLL0("filter.cwu.var1.low",            filterCWU[filterVar1].low);
	GetPropLL0("filter.cwu.var1.high",           filterCWU[filterVar1].high);
	GetPropLL0("filter.cwu.var2.low",            filterCWU[filterVar2].low);
	GetPropLL0("filter.cwu.var2.high",           filterCWU[filterVar2].high);
	GetPropLL0("filter.am.var1.low",             filterAM[filterVar1].low);
	GetPropLL0("filter.am.var1.high",            filterAM[filterVar1].high);
	GetPropLL0("filter.am.var2.low",             filterAM[filterVar2].low);
	GetPropLL0("filter.am.var2.high",            filterAM[filterVar2].high);
	GetPropLL0("filter.sam.var1.low",            filterSAM[filterVar1].low);
	GetPropLL0("filter.sam.var1.high",           filterSAM[filterVar1].high);
	GetPropLL0("filter.sam.var2.low",            filterSAM[filterVar2].low);
	GetPropLL0("filter.sam.var2.high",           filterSAM[filterVar2].high);
	GetPropLL0("filter.dsb.var1.low",            filterDSB[filterVar1].low);
	GetPropLL0("filter.dsb.var1.high",           filterDSB[filterVar1].high);
	GetPropLL0("filter.dsb.var2.low",            filterDSB[filterVar2].low);
	GetPropLL0("filter.dsb.var2.high",           filterDSB[filterVar2].high);
}
...
void filter_high_changed(int id, int increment) {
  ...
  RECEIVER *rx = receiver[id];
  long long low = rx->filter_low;
  long long high = rx->filter_high;
  long long new;
