...
//
extern void sliders_filter_low(int id, long long value);
extern void sliders_filter_high(int id, long long value);
extern void sliders_filter_width(int id, long long  value);
extern void sliders_filter_shift(int id, long long value);
