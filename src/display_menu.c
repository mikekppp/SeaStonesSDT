...
void display_menu(GtkWidget *parent) {
  ...
  gtk_grid_set_column_homogeneous(GTK_GRID(grid), G_TRUE);
  ...
  gtk_grid_set_row_homogeneous(GTK_GRID(general_grid), G_TRUE);
  ...
  gtk_grid_set_row_homogeneous(GTK_GRID(peaks_grid), G_TRUE);
