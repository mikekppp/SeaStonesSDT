...
struct _rnnr;                 // forward decl of the tag
typedef struct _rnnr* RNNR;   // (optional) pointer alias
struct _sbnr;                 // forward decl of the tag
typedef struct _sbnr* SBNR;   // (optional) pointer alias
